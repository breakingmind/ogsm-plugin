...
5. Before saving, show target path and new-file notice or diff.
6. Run `node ../../scripts/validate-profile.js <profile-file>` after drafting a saved profile.
7. Ask the user to confirm before saving or changing Objective, Goals, Strategies, MD, or MP.
