...
5. Run `node ../../scripts/validate-profile.js <profile-file>` after drafting a saved profile.
6. Ask the user to confirm before saving or changing Objective, Goals, Strategies, MD, or MP.
